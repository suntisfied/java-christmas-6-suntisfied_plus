...
public class PromotionPreview {
    Map<String, String> build(VisitDate visitDate, MenuOrder menuOrder) {
        ...
        for (int i = 0; i < promotionHeadTexts.size(); i++) {
            ...
            promotionPreviews.put(promotionHeadTexts.get(i).getMessage(), promotionFormatter.format(visitDate,
                    menuOrder));
        }
