...
class TotalBenefitTest {
    ...
    MenuOrder menuOrder = new MenuOrder("티본스테이크-3,양송이수프-1,아이스크림-2,레드와인-2");

    @Test
    public void calculateTotalBenefit() {
        TotalBenefit totalBenefit = new Converter().convertToTotalBenefit(new VisitDate(10), menuOrder);
